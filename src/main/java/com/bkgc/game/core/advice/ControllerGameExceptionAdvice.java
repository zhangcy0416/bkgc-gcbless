package com.bkgc.game.core.advice;
 ...
 */
@ControllerAdvice("com.bkgc.game.web.Controller")
public class ControllerGameExceptionAdvice {

//    @Autowired
//    private LogService logService;

    private static Logger log = LoggerFactory.getLogger(ControllerGameExceptionAdvice.class);
